...
throw new Error("Module build failed: SyntaxError: C:/users/szerman/projekty/zadanie16.4/src/containers/App.js: Unexpected token, expected ; (22:15)\n\n  20 | }\n  21 | \n> 22 | removeTodo(id) {\n     |                ^\n  23 |     const remainder = this.state.data.filter(todo => todo.id !== id);\n  24 |     this.setState({data: remainder});\n  25 | }\n");
